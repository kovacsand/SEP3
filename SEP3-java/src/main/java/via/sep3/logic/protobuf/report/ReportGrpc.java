...
public final class ReportGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<via.sep3.logic.protobuf.report.ReportFilter,
      via.sep3.logic.protobuf.report.ReportList> getGetReportsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetReports",
      requestType = via.sep3.logic.protobuf.report.ReportFilter.class,
      responseType = via.sep3.logic.protobuf.report.ReportList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<via.sep3.logic.protobuf.report.ReportFilter,
      via.sep3.logic.protobuf.report.ReportList> getGetReportsMethod() {
    io.grpc.MethodDescriptor<via.sep3.logic.protobuf.report.ReportFilter, via.sep3.logic.protobuf.report.ReportList> getGetReportsMethod;
      ...
      synchronized (ReportGrpc.class) {
        if ((getGetReportsMethod = ReportGrpc.getGetReportsMethod) == null) {
          ReportGrpc.getGetReportsMethod = getGetReportsMethod =
              io.grpc.MethodDescriptor.<via.sep3.logic.protobuf.report.ReportFilter, via.sep3.logic.protobuf.report.ReportList>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetReports"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  via.sep3.logic.protobuf.report.ReportFilter.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  via.sep3.logic.protobuf.report.ReportList.getDefaultInstance()))
  ...
  public static abstract class ReportImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getReports(via.sep3.logic.protobuf.report.ReportFilter request,
        io.grpc.stub.StreamObserver<via.sep3.logic.protobuf.report.ReportList> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                via.sep3.logic.protobuf.report.ReportFilter,
                via.sep3.logic.protobuf.report.ReportList>(
  ...
  public static final class ReportBlockingStub extends io.grpc.stub.AbstractBlockingStub<ReportBlockingStub> {
    ...
    /**
     */
    public via.sep3.logic.protobuf.report.ReportList getReports(via.sep3.logic.protobuf.report.ReportFilter request) {
  ...
  public static final class ReportFutureStub extends io.grpc.stub.AbstractFutureStub<ReportFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<via.sep3.logic.protobuf.report.ReportList> getReports(
        via.sep3.logic.protobuf.report.ReportFilter request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_REPORTS:
          serviceImpl.getReports((via.sep3.logic.protobuf.report.ReportFilter) request,
              (io.grpc.stub.StreamObserver<via.sep3.logic.protobuf.report.ReportList>) responseObserver);
          break;
        default:
  ...
  private static abstract class ReportBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return via.sep3.logic.protobuf.report.ReportOuterClass.getDescriptor();
    }
